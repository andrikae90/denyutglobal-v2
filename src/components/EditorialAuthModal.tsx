...
export const EditorialAuthModal: React.FC<EditorialAuthModalProps> = ({
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      // Mode produksi: hanya passphrase asli yang dikirim.
      // Worker melakukan SHA-256 dan mencocokkannya dengan Secret Cloudflare.
      ...
      <div id="editorial-auth-modal-container" className="w-full max-w-md bg-white rounded-2xl shadow-2xl border border-slate-200 overflow-hidden text-slate-900">
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100 bg-slate-50/80">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 id="editorial-auth-title" className="text-base font-bold">Akses Ruang Redaksi</h2>
              <p className="text-xs text-slate-500">Area terbatas untuk jurnalis & editor DenyutGlobal</p>
            </div>
          </div>
